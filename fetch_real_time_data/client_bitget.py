...
class ClientBITGET(threading.Thread):
    """
    ...
    Notes
    -----
    This module defines the base 'ClientBITGET' class, which manages persistent
    ...
    - 'bitget_perptual_futures_orderbook.py' implements 'BITGETOrderbookManager', a WebSocket client for
    handling L1 orderbook data in real-time.

    Both this base client and its WebSocket subclasses are implemented according to 
    the official Bitget Exchange API documentation as of 2025-08-25. 
