...
class ClientDERIBIT(threading.Thread):
    """
    ...
    Notes
    -----
    This module defines the base 'ClientDERIBIT' class, which manages persistent
    ...
    - 'deribit_perptual_futures_orderbook.py' implements 'DERIBITOrderbookManager', a WebSocket client for
    handling L2 orderbook data in real-time.

    Both this base client and its WebSocket subclasses are implemented according to 
    the official Deribit Exchange API documentation as of 2025-08-25. 
