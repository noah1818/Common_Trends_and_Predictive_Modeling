...
class ClientBYBIT(threading.Thread):
    """
    ...
    Notes
    -----
    This module defines the base 'ClientBYBIT' class, which manages persistent
    ...
    - 'bybit_perptual_futures_orderbook.py' implements 'BYBITOrderbookManager', a WebSocket client for
    handling L2 orderbook data in real-time.

    Both this base client and its WebSocket subclasses are implemented according to 
    the official Bybit Exchange API documentation as of 2025-08-25. 
