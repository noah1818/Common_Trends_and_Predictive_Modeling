...
class ClientHTX(threading.Thread):
    """
    ...
    Notes
    -----
    This module defines the base 'ClienHTX' class, which manages persistent
    ...
    - 'htx_perptual_futures_orderbook.py' implements 'HTXOrderbookManager', a WebSocket client for
    handling L1 orderbook data in real-time.

    Both this base client and its WebSocket subclasses are implemented according to 
    the official HTX Exchange API documentation as of 2025-08-25. 
    Reference: https://www.htx.com/en-us/opend/newApiPages/
