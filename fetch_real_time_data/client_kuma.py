...
class ClientKUMA(threading.Thread):
    """
    ...
    Notes
    -----
    This module defines the base 'ClientKUMA' class, which manages persistent
    ...
    - 'kuma_perptual_futures_orderbook.py' implements 'KUMAOrderbookManager', a WebSocket client for
    handling L2 orderbook data in real-time.

    Both this base client and its WebSocket subclasses are implemented according to 
    the official Kuma (formerly Idex) Exchange API documentation as of 2025-08-25. 
