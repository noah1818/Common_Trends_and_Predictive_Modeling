...
class ClientBINANCE(threading.Thread):
    """
    ...
    Notes
    -----
    This module defines the base 'ClientBINANCE' class, which manages persistent
    ...
    - 'binance_perptual_futures_orderbook.py' implements 'BINANCEOrderbookManager', a WebSocket client for
    handling L1 orderbook data in real-time.

    Both this base client and its WebSocket subclasses are implemented according to 
    the official Binance Exchange API documentation as of 2025-08-25. 
    ...
    def _on_error(self, ws: websocket.WebSocketApp, error: Exception | str | None) -> None:
        ...
        try: 
            ...
            print(f"[{self._exchange}] on_error exception: {excp}", flush=True)

    def _on_ping(self, ws: websocket.WebSocketApp, message: bytes) -> None:
        """
        Responds to WebSocket ping frames with a specific pong, see https://developers.binance.com/docs/binance-spot-api-docs/websocket-api/general-api-information.
